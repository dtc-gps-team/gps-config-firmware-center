...
/**
 * Body ของ `POST /config/{id}/decide` (Stage 4) — ConfigEngineer ปักผลตัดสินใจเองหลังดู
...
export class DecideConfigDto {
  ...
  /**
   * (optional) user id ของ Operation ที่ ConfigEngineer อยากเจาะจงให้ดู Config นี้เป็น
