...
| **FieldTechnician** ⚠️ | ช่างหน้างาน | Mobile เท่านั้น | รับงานที่ได้รับมอบหมาย, ลงทะเบียนกล่องใหม่, ทดสอบกับ Device Simulator (ไม่บังคับ), กดยืนยันติดตั้งสำเร็จ, ส่ง Change Request |
...
| **Push Notification / แจ้งเตือน** | R, U (mark read) |
...
- **Decommission Device**: ร่างนี้ให้ Operation และ Admin ทำได้ทั้งคู่ — ยืนยันว่าต้องการให้ทั้งสอง Role ทำได้หรือจำกัดแค่ Role เดียว
