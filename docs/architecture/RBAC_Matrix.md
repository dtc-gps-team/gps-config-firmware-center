...
| `/devices` | GET | `listDevices` | ทุก Role ที่ login แล้ว (resource `devices` action `Read` · Device Search — list + filter `search`/`deviceModel`/`protocol`/`status` · ดู changelog แก้ครั้งที่ 23) |
