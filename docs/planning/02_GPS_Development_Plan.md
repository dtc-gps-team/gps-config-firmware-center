...
| 7 | Sprint 2 | 27/09/2026 | ~~มอบหมายงาน + ติดตามสถานะ (Web)~~ — **ยกเลิกถาวร** ไม่ทำหน้าแยกในรูปแบบไหนเลย (มติพี่เลี้ยงล่าสุด, สืบเนื่องจาก PR #144 review — ดู RBAC_Matrix.md Section 6 แก้ครั้งที่ 26) — **อัปเดต 2026-09-14:** แนวคิดย้ายไปรวมกับ Campaign Wizard (แถวที่ 21) ที่เคยเขียนไว้ตรงนี้ก็ถูกตัดออกอีกที — พี่เลี้ยงชี้ชัดว่า Campaign มีไว้ติดตาม/บำรุงรักษาอุปกรณ์เป็นกลุ่มเท่านั้น การมอบหมายงานให้ช่างหน้างานเป็นหน้าที่ของระบบแยกที่บริษัทมีอยู่แล้ว **ไม่มีที่ไหนในระบบนี้ทำเรื่องมอบหมายงานอีกเลย** (ดู RBAC_Matrix.md changelog แก้ครั้งที่ 29) | Web | A | Cancelled |
