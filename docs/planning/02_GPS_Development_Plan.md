...
| 7 | Sprint 2 | 27/09/2026 | ~~มอบหมายงาน + ติดตามสถานะ (Web)~~ — **ยกเลิกถาวร** ไม่ทำหน้าแยกในรูปแบบไหนเลย (มติพี่เลี้ยงล่าสุด, สืบเนื่องจาก PR #144 review — ดู RBAC_Matrix.md Section 6 แก้ครั้งที่ 26) การมอบหมายงานย้ายไปอยู่ในขั้นตอน "มอบหมายผู้รับผิดชอบหน้างาน" ตอนสร้าง Campaign แทน (แถวที่ 21) | Web | A | Cancelled |
...
| 21 | Sprint 3 | 11/10/2026 | Campaign Wizard (สร้างแคมเปญครบขั้นตอน) — **รวมขั้น "มอบหมายผู้รับผิดชอบหน้างาน"** ที่เดิมเป็นแถวที่ 7 แยกต่างหาก (ยกเลิกแล้ว — ดู RBAC_Matrix.md Section 6 แก้ครั้งที่ 26) | Web | A | Not Tested |
